...
- [nexusunited/spryker-kit-intellij-plugin](https://github.com/nexusunited/spryker-kit-intellij-plugin) ([1.0.8](https://github.com/nexusunited/spryker-kit-intellij-plugin/releases/tag/1.0.8), today) - Supports the development of Spryker applications with Intellij Integration.
